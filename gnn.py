...
def run_advanced_gnn_simulation(instance_file: str, dt: float = 0.5, save_metrics: bool = False, show_animation: bool = True):
...
def run_advanced_gnn_batch_experiments():
    ...
    if summary_results:
        timestamp = datetime.now().strftime("%Y%m%d_%H%M%S")
        summary_file = f"GNN_results/gnn_approach.csv"
